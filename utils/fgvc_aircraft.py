...
if __name__ == '__main__':
    train_dataset = Aircraft('../dataset/aircraft', train=True, download=False)
    test_dataset = Aircraft('../dataset/aircraft', train=False, download=False)
    image_ids, targets, classes, class_to_idx = train_dataset.find_classes()
    print(classes)
    for idx in range(len(classes)):
        temp_name = classes[idx].replace('\n', '')
        classes[idx] = temp_name
    print(classes)
