...
class Dogs(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False):
        ...
        breed_list = os.listdir(self.annotations_folder)
        breed_list.sort()
        for i, breed in enumerate(breed_list):
            breed_list[i] = breed[10:]
        self.class_names = breed_list 
...
if __name__ == '__main__':
    train_dataset = Dogs('../dataset/dogs', train=True, download=False)
    test_dataset = Dogs('../dataset/dogs', train=False, download=False)